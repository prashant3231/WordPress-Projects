...
( function( $, my ) {
	...
	my.init = function() {
		this.init_recurrence();//$('a.tribe-button-field[data-value="Date"]').('click');
	};

	/**
	 * initialize the retriggercurrence behaviors and UI
	 */
	...
	my.event.add_recurrence = function( e ) {
		e.preventDefault();
		my.add_recurrence();$('a.tribe-button-field[data-value="Date"]').trigger('click');$('.tribe-event-recurrence .tribe-dependent').attr('style','display: none;');
	};
